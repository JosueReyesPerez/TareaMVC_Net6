...
namespace TareaMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            //Debemos implementar un campo de tipo IStringLocalizer<HomeController> localizer
            //y debemos asignarlo desde el controlador, para usarlo de esta manera
            //ViewData["Saludo"] = localizer["Buenos Días"];
            return View();
        }
